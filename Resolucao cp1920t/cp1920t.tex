...
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{}\Varid{g}\mathrel{=}\alt{\Varid{nil}}{\Varid{k}}{}\<[E]%
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{}\Varid{k}\mathrel{=}\mathsf{conc}\comp (\Varid{discc}\times\Varid{id}){}\<[E]%
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{}\Varid{discc}\;(\Varid{a},\Varid{x})\mathrel{=}[\mskip1.5mu (\Varid{a},\Varid{b})\mid \Varid{b}\leftarrow \Varid{x}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\par Para a função auxiliar tar do \ensuremath{\Varid{dic\char95 exp}} usamos um catamorfismo de árvores de expressão, 
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{k}}{\Varid{h}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{k}\;\Varid{v}\mathrel{=}[\mskip1.5mu (\text{\ttfamily \char34 \char34},\Varid{v})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h}\mathrel{=}{}\<[8]%
\>[8]{}\uncurry{\Varid{f}}\comp (\Varid{id}\times\Varid{concat}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{f}\;\Varid{x}\;\Varid{y}\mathrel{=}\map \;((\Varid{curry}\;\mathsf{conc}\;\Varid{x})\times\Varid{id})\;\Varid{y}{}\<[E]%
\\[\blanklineskip]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dic\char95 rd}\mathrel{=}\Varid{curry}\;(\Varid{finaliza}\comp (\Varid{hyloExp}\;\Varid{dic\char95 rd\char95 CataGen}\;\Varid{dic\char95 rd\char95 AnaGen})){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{where}\;\Varid{finaliza}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{Nothing}{}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{finaliza}\;\Varid{lista}\mathrel{=}(\Conid{Just}\comp \Varid{iSort}\comp \Varid{nub})\;\Varid{lista}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dic\char95 rd\char95 CataGen}\mathrel{=}\alt{\Varid{singl}}{\Varid{concat}\comp \p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dic\char95 rd\char95 AnaGen}\;(\text{\ttfamily \char34 \char34},\Conid{Var}\;\Varid{a})\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 rd\char95 AnaGen}\;(\Varid{p},\Conid{Var}\;\anonymous )\mathrel{=}i_2\;(\Varid{p},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{dic\char95 rd\char95 AnaGen}\;(\Varid{p},\Conid{Term}\;\Varid{j}\;\Varid{n})\mathrel{=}\mathbf{if}\;(\Varid{isPrefix}\;\Varid{j}\;\Varid{p})\;\mathbf{then}\;i_2\;(\Varid{j},[\mskip1.5mu (\Varid{sufixo},\Varid{o})\mid \Varid{o}\leftarrow \Varid{n}\mskip1.5mu])\;\mathbf{else}\;i_2\;(\Varid{p},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{24}{}\<[24]%
\>[24]{}\mathbf{where}\;\Varid{sufixo}\mathrel{=}\Varid{drop}\;(\length \;\Varid{j})\;\Varid{p}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isPrefix}\;\Varid{x}\;\Varid{l}\mathrel{=}\Varid{elem}\;\Varid{x}\;(\Varid{prefixes}\;\Varid{l}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dic\char95 in}\;\Varid{p}\;\Varid{t}\;\Varid{dici}\mathrel{=}\mathbf{if}\;(\Varid{exists}\;\Varid{t}\;(\Varid{dic\char95 rd}\;\Varid{p}\;\Varid{dici}))\;\mathbf{then}\;\Varid{dici}\;\mathbf{else}\;\Varid{anaExp}\;\Varid{dic\char95 in\char95 AnaGen}\;(\Varid{dici},(\Varid{p},\Varid{t},\Conid{True})){}\<[E]%
\\
\>[B]{}\hsindent{16}{}\<[16]%
\>[16]{}\mathbf{where}\;\Varid{exists}\;\anonymous \;\Conid{Nothing}\mathrel{=}\Conid{False}{}\<[E]%
\\
\>[16]{}\hsindent{6}{}\<[22]%
\>[22]{}\Varid{exists}\;\Varid{o}\;(\Conid{Just}\;\Varid{x})\mathrel{=}\Varid{elem}\;\Varid{o}\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 in\char95 AnaGen}\;(\Conid{Var}\;\Varid{a},(\anonymous ,\anonymous ,\Conid{False}))\mathrel{=}i_1\;\Varid{a}{}\<[108]%
\>[108]{}\mbox{\onelinecomment  1}{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 in\char95 AnaGen}\;(\Conid{Var}\;\Varid{a},(\Varid{p},\Varid{t},\anonymous ))\mathrel{=}\mathbf{if}\;(\Varid{p}\equiv \text{\ttfamily \char34 \char34}){}\<[E]%
\\
\>[B]{}\hsindent{37}{}\<[37]%
\>[37]{}\mathbf{then}\;i_2\;(\text{\ttfamily \char34 \char34},[\mskip1.5mu (\Conid{Var}\;\Varid{a},(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False})),(\Conid{Var}\;\Varid{t},(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False}))\mskip1.5mu]){}\<[108]%
\>[108]{}\mbox{\onelinecomment  2}{}\<[E]%
\\
\>[B]{}\hsindent{37}{}\<[37]%
\>[37]{}\mathbf{else}\;i_2\;(\text{\ttfamily \char34 \char34},[\mskip1.5mu (\Conid{Var}\;\Varid{a},(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False})),(\Conid{Term}\;\Varid{p}\;[\mskip1.5mu \Conid{Var}\;\Varid{t}\mskip1.5mu],(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False}))\mskip1.5mu])\mbox{\onelinecomment  3}{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 in\char95 AnaGen}\;(\Conid{Term}\;\Varid{j}\;\Varid{n},(\anonymous ,\anonymous ,\Conid{False}))\mathrel{=}i_2\;(\Varid{j},[\mskip1.5mu (\Varid{o},(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False}))\mid \Varid{o}\leftarrow \Varid{n}\mskip1.5mu]){}\<[108]%
\>[108]{}\mbox{\onelinecomment  4}{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 in\char95 AnaGen}\;(\Conid{Term}\;\Varid{j}\;\Varid{n},(\Varid{p},\Varid{t},\Conid{True}))\mathrel{=}\mathbf{if}\;(\Varid{isPrefix}\;\Varid{j}\;\Varid{p}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{then}\;\mathbf{if}\;(\Varid{p}\equiv \Varid{j})\;\mathbf{then}\;i_2\;(\Varid{j},\Varid{cons}\;({}\<[39]%
\>[39]{}(\Conid{Var}\;\Varid{t},(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False})){}\<[63]%
\>[63]{},{}\<[63E]%
\>[66]{}[\mskip1.5mu (\Varid{o},(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False}))\mid \Varid{o}\leftarrow \Varid{n}\mskip1.5mu])){}\<[108]%
\>[108]{}\mbox{\onelinecomment  5}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathbf{else}\;\mathbf{if}\;(\Varid{insertProbe}\;\Varid{sufixo}\;\Varid{n}){}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\mathbf{then}\;i_2\;(\Varid{j},\Varid{insertP}\;\Varid{sufixo}\;\Varid{t}\;\Varid{n}){}\<[108]%
\>[108]{}\mbox{\onelinecomment  6}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\mathbf{else}\;i_2\;(\Varid{j},\Varid{cons}\;({}\<[29]%
\>[29]{}(\Conid{Term}\;\Varid{sufixo}\;[\mskip1.5mu \Conid{Var}\;\Varid{t}\mskip1.5mu],(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False})){}\<[66]%
\>[66]{},{}\<[69]%
\>[69]{}[\mskip1.5mu (\Varid{o},(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False}))\mid \Varid{o}\leftarrow \Varid{n}\mskip1.5mu]{}\<[100]%
\>[100]{})){}\<[108]%
\>[108]{}\mbox{\onelinecomment  7}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{else}\;\mathbf{if}\;(\Varid{isPrefix}\;\Varid{p}\;\Varid{j})\;\mathbf{then}\;i_2\;(\Varid{p},[\mskip1.5mu (\Conid{Var}\;\Varid{t},(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False})),(\Conid{Term}\;{}\<[70]%
\>[70]{}\Varid{sufixo2}\;\Varid{n},(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False})){}\<[96]%
\>[96]{}\mskip1.5mu]){}\<[108]%
\>[108]{}\mbox{\onelinecomment  8}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{else}\;i_2\;(\text{\ttfamily \char34 \char34},[\mskip1.5mu {}\<[19]%
\>[19]{}(\Conid{Term}\;\Varid{p}\;[\mskip1.5mu \Conid{Var}\;\Varid{t}\mskip1.5mu],(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False})){}\<[51]%
\>[51]{},{}\<[51E]%
\>[54]{}(\Conid{Term}\;\Varid{j}\;\Varid{n},(\Varid{p},\Varid{t},\Conid{False})){}\<[78]%
\>[78]{}\mskip1.5mu]){}\<[108]%
\>[108]{}\mbox{\onelinecomment  9}{}\<[E]%
\\
\>[19]{}\hsindent{4}{}\<[23]%
\>[23]{}\mathbf{where}\;\Varid{sufixo}\mathrel{=}\Varid{drop}\;(\length \;\Varid{j})\;\Varid{p}{}\<[E]%
\\
\>[23]{}\hsindent{6}{}\<[29]%
\>[29]{}\Varid{sufixo2}\mathrel{=}\Varid{drop}\;(\length \;\Varid{p})\;\Varid{j}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\ 
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{insertProbe}\;\Varid{p}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{False}{}\<[E]%
\\
\>[B]{}\Varid{insertProbe}\;\Varid{p}\;((\Conid{Var}\;\Varid{a})\mathbin{:}\Varid{xs})\mathrel{=}\Conid{False}\mathrel{\vee}(\Varid{insertProbe}\;\Varid{p}\;\Varid{xs}){}\<[E]%
\\
\>[B]{}\Varid{insertProbe}\;\Varid{p}\;((\Conid{Term}\;\Varid{j}\;\Varid{o})\mathbin{:}\Varid{xs})\mathrel{=}(\Varid{elem}\;\Varid{j}\;(\Varid{prefixes}\;\Varid{p}))\mathrel{\vee}(\Varid{insertProbe}\;\Varid{p}\;\Varid{xs}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{insertP}\;\anonymous \;\anonymous \;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{insertP}\;\Varid{p}\;\Varid{t}\;((\Conid{Var}\;\Varid{a})\mathbin{:}\Varid{xs})\mathrel{=}(\Conid{Var}\;\Varid{a},(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False}))\mathbin{:}(\Varid{insertP}\;\Varid{p}\;\Varid{t}\;\Varid{xs}){}\<[E]%
\\
\>[B]{}\Varid{insertP}\;\Varid{p}\;\Varid{t}\;((\Conid{Term}\;\Varid{o}\;\Varid{n})\mathbin{:}\Varid{xs})\mathrel{=}\mathbf{if}\;(\Varid{elem}\;\Varid{o}\;(\Varid{prefixes}\;\Varid{p})){}\<[E]%
\\
\>[B]{}\hsindent{31}{}\<[31]%
\>[31]{}\mathbf{then}\;(\Conid{Term}\;\Varid{o}\;\Varid{n},(\Varid{p},\Varid{t},\Conid{True}))\mathbin{:}(\Varid{insertP}\;\Varid{p}\;\Varid{t}\;\Varid{xs}){}\<[E]%
\\
\>[31]{}\hsindent{5}{}\<[36]%
\>[36]{}\mathbf{else}\;(\Conid{Term}\;\Varid{o}\;\Varid{n},(\text{\ttfamily \char34 \char34},\text{\ttfamily \char34 \char34},\Conid{False}))\mathbin{:}(\Varid{insertP}\;\Varid{p}\;\Varid{t}\;\Varid{xs}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
...
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{h}}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{h}\;(\Varid{x},(\anonymous ,\Conid{Nothing}))\mathrel{=}\Conid{Just}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{h}\;(\anonymous ,(\anonymous ,\Varid{r}))\mathrel{=}\Varid{r}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{h}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(\Varid{x},(\Conid{Nothing},\anonymous ))\mathrel{=}\Conid{Just}\;\Varid{x}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(\anonymous ,(\Varid{l},\anonymous ))\mathrel{=}\Varid{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd}\;\Varid{a}\;\Varid{x}\mathrel{=}(\Varid{cataBTree}\;\Varid{g})\;\Varid{x}\;\Varid{x}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{g1}\;\anonymous \;\anonymous \;\Varid{e}\mathrel{=}\Conid{Node}\;(\Varid{e},(\Conid{Empty},\Conid{Empty})){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{g2}\;(e_1 ,(\Varid{l1},\Varid{r1}))\;(\Conid{Node}\;(e_2 ,(\Varid{l2},\Varid{r2})))\;\Varid{e}\mathrel{=}\mathbf{if}\;(\Varid{e}\equiv e_1 )\;\mathbf{then}\;\Conid{Node}\;(e_2 ,(\Varid{l2},\Varid{r2})){}\<[E]%
\\
\>[11]{}\hsindent{7}{}\<[18]%
\>[18]{}\mathbf{else}\;{}\<[24]%
\>[24]{}\mathbf{if}\;(\Varid{e}\mathbin{<}e_1 )\;\mathbf{then}\;\Conid{Node}\;(e_1 ,((\Varid{l1}\;\Varid{l2}\;\Varid{e}),\Varid{r2}))\;\mathbf{else}\;\Conid{Node}\;(e_1 ,(\Varid{l2},(\Varid{r1}\;\Varid{r2}\;\Varid{e}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\mathbf{where}\;\Varid{g}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isOrd}\;\Varid{j}\mathrel{=}(\Varid{cataBTree}\;\Varid{g})\;\Varid{j}\;\Varid{j}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{curry}\;\Varid{g2}}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{g1}\;\anonymous \;\anonymous \mathrel{=}\Conid{True}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{g2}\;((\Varid{a},(\Varid{l},\Varid{r})),\Conid{Node}\;(\Varid{aa},(\Varid{ll},\Varid{rr})))\mathrel{=}\Varid{checkHead}\mathrel{\wedge}\Varid{checkSons}{}\<[E]%
\\
\>[12]{}\hsindent{5}{}\<[17]%
\>[17]{}\mathbf{where}\;\Varid{checkHead}\mathrel{=}\Varid{isBigger}\;\Varid{a}\;(\Varid{maisEsq}\;\Varid{ll})\mathrel{\wedge}\Varid{isSmaller}\;\Varid{a}\;(\Varid{maisDir}\;\Varid{rr}){}\<[E]%
\\
\>[17]{}\hsindent{6}{}\<[23]%
\>[23]{}\Varid{checkSons}\mathrel{=}\Varid{l}\;\Varid{ll}\mathrel{\wedge}\Varid{r}\;\Varid{rr}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isBigger}\;\Varid{x}\;\Conid{Nothing}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{isBigger}\;\Varid{x}\;(\Conid{Just}\;\Varid{j})\mathrel{=}\Varid{x}\mathbin{>}\Varid{j}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isSmaller}\;\Varid{x}\;\Conid{Nothing}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{isSmaller}\;\Varid{x}\;(\Conid{Just}\;\Varid{j})\mathrel{=}\Varid{x}\mathbin{<}\Varid{j}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
...
\\
\>[B]{}\Varid{rrot}\;(\Conid{Node}\;(\Varid{a},(\Varid{b},\Varid{c})))\mathrel{=}\Varid{x}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}\;\Varid{x}\;\Varid{a}\;\Conid{Empty}\;\Varid{c}\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{b},\Varid{c})){}\<[E]%
\\
\>[17]{}\hsindent{6}{}\<[23]%
\>[23]{}\Varid{x}\;\Varid{a}\;(\Conid{Node}\;(\Varid{aa},(\Varid{bb},\Varid{cc})))\;\Varid{c}\mathrel{=}\Conid{Node}\;(\Varid{aa},(\Varid{bb},(\Conid{Node}\;(\Varid{a},(\Varid{cc},\Varid{c}))))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
...
\\
\>[B]{}\Varid{lrot}\;(\Conid{Node}\;(\Varid{a},(\Varid{b},\Varid{c})))\mathrel{=}\Varid{x}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mathbf{where}\;\Varid{x}\;\Varid{a}\;\Varid{b}\;\Conid{Empty}\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{b},\Varid{c})){}\<[E]%
\\
\>[15]{}\hsindent{6}{}\<[21]%
\>[21]{}\Varid{x}\;\Varid{a}\;\Varid{b}\;(\Conid{Node}\;(\Varid{aa},(\Varid{bb},\Varid{cc})))\mathrel{=}\Conid{Node}\;(\Varid{aa},((\Conid{Node}\;(\Varid{a},(\Varid{b},\Varid{bb}))),\Varid{cc})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{splay}\;\Varid{l}\;\Varid{t}\mathrel{=}(\Varid{cataList}\;\Varid{splayCataGen})\;\Varid{l}\;\Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{splayCataGen}\mathrel{=}\alt{\Varid{g1}}{\Varid{curry}\;\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\mathbf{where}\;\Varid{g1}\;\anonymous \;\Varid{bt}\mathrel{=}\Varid{bt}{}\<[E]%
\\
\>[8]{}\hsindent{6}{}\<[14]%
\>[14]{}\Varid{g2}\;((\Varid{j},\Varid{n}),\Varid{bt})\mathrel{=}\mathbf{if}\;(\Varid{j})\;\mathbf{then}\;\Varid{n}\;(\Varid{rrot}\;\Varid{bt})\;\mathbf{else}\;\Varid{n}\;(\Varid{lrot}\;\Varid{bt}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{outBdt}\;(\Conid{Query}\;(\Varid{s},(\Varid{l},\Varid{r})))\mathrel{=}i_2\;(\Varid{s},(\Varid{l},\Varid{r})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseBdt}\;\Varid{g}\;\Varid{h}{}\<[14]%
\>[14]{}\mathrel{=}\Varid{id}+(\Varid{g}{}\<[27]%
\>[27]{}\times(\Varid{h}\times\Varid{h})){}\<[E]%
\\[\blanklineskip]%
...
&
    \ensuremath{\Conid{Dec}\mathbin{+}\Conid{A}\times(\Conid{Bdt}\times\Conid{Bdt})} 
...
\\
\>[B]{}\Varid{navLTree}\;\Varid{x}\;\Varid{y}\mathrel{=}\Varid{cataLTree}\;\Varid{navLTreeGen}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{navLTreeGen}\mathrel{=}\alt{\Varid{g1}}{\Varid{curry}\;\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\mathbf{where}\;\Varid{g1}\;\Varid{x}\;\anonymous \mathrel{=}\Conid{Leaf}\;\Varid{x}{}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{g2}\;((\Varid{a},\Varid{b}),[\mskip1.5mu \mskip1.5mu])\mathrel{=}\Conid{Fork}\;(\conj{\Varid{a}}{\Varid{b}}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[6]{}\hsindent{6}{}\<[12]%
\>[12]{}\Varid{g2}\;((\Varid{a},\Varid{b}),(\Varid{x}\mathbin{:}\Varid{xs}))\mathrel{=}\mathbf{if}\;(\Varid{x})\;\mathbf{then}\;\p1\mathbin{\$}\Varid{g}\;\mathbf{else}\;\p2\mathbin{\$}\Varid{g}{}\<[E]%
\\
\>[12]{}\hsindent{12}{}\<[24]%
\>[24]{}\mathbf{where}\;\Varid{g}\mathrel{=}\conj{\Varid{a}}{\Varid{b}}\;\Varid{xs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
\\
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{bnavLTree}\;\Varid{lt}\;\Varid{bt}\mathrel{=}(\Varid{cataLTree}\;\Varid{bnavLTreeGen})\;\Varid{lt}\;\Varid{lt}\;\Varid{bt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bnavLTreeGen}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{g1}\;\Varid{j}\;\anonymous \;\anonymous \mathrel{=}\Conid{Leaf}\;\Varid{j}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{g2}\;\anonymous \;\Varid{lt}\;\Conid{Empty}\mathrel{=}\Varid{lt}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{g2}\;(\Varid{l1},\Varid{r1})\;(\Conid{Fork}\;(\Varid{l2},\Varid{r2}))\;(\Conid{Node}\;(\Varid{b},(\Varid{l3},\Varid{r3})))\mathrel{=}\mathbf{if}\;(\Varid{b})\;\mathbf{then}\;\Varid{l1}\;\Varid{l2}\;\Varid{l3}\;\mathbf{else}\;\Varid{r1}\;\Varid{r2}\;\Varid{r3}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
...
\column{39}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pbnavLTree}\;\Varid{lt}\;\Varid{bt}\mathrel{=}(\Varid{cataLTree}\;\Varid{pbnavLTreeGen})\;\Varid{lt}\;\Varid{lt}\;\Varid{bt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pbnavLTreeGen}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g1}\;\Varid{j}\;\anonymous \;\anonymous \mathrel{=}\Conid{D}\;[\mskip1.5mu (\Conid{Leaf}\;\Varid{j},\mathrm{1.0})\mskip1.5mu]{}\<[39]%
\>[39]{}\mbox{\onelinecomment 1}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;\anonymous \;\Varid{bt}\;\Conid{Empty}\mathrel{=}\Conid{D}\;[\mskip1.5mu (\Varid{bt},\mathrm{1.0})\mskip1.5mu]\mbox{\onelinecomment 2 }{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\Varid{l1},\Varid{r1})\;(\Conid{Fork}\;(\Varid{l2},\Varid{r2}))\;(\Conid{Node}\;(\Varid{dist},(\Varid{l3},\Varid{r3})))\mathrel{=}{}\<[E]%
\\
\>[9]{}\hsindent{9}{}\<[18]%
\>[18]{}(\Conid{D}\comp \mathsf{conc}\comp (\Varid{n}\times\Varid{n}))\;((\Varid{l1}\;\Varid{l2}\;\Varid{l3},\Varid{probEsq}),(\Varid{r1}\;\Varid{r2}\;\Varid{r3},\Varid{probDir}))\mbox{\onelinecomment 3}{}\<[E]%
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{probEsq}\mathrel{=}\Varid{getTrueProb}\;(\Varid{getProbs}){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{probDir}\mathrel{=}\Varid{getFalseProb}\;(\Varid{getProbs}){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{getProbs}\mathrel{=}(\map \;(\Varid{id}\times\Varid{sum})\comp \Varid{collectProb}\comp \Varid{unD})\;\Varid{dist}{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{n}\mathrel{=}{}\<[22]%
\>[22]{}\Varid{distProb}\comp (\Varid{unD}\times\Varid{id}){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{unD}\mathrel{=}\Varid{\Conid{Probability}.unD}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{getTrueProb}\mathrel{=}\Varid{cataList}\;\Varid{g}\mbox{\onelinecomment  4}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{g1}\;\anonymous \mathrel{=}\mathrm{0.0}{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{g2}\;((\Varid{j},\Varid{n}),\Varid{o})\mathrel{=}\mathbf{if}\;(\Varid{j})\;\mathbf{then}\;\Varid{n}\;\mathbf{else}\;\Varid{o}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{getFalseProb}\mathrel{=}\Varid{cataList}\;\Varid{g}\mbox{\onelinecomment 5}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
...
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{g2}\;((\Varid{j},\Varid{n}),\Varid{o})\mathrel{=}\mathbf{if}\;(\neg \;\Varid{j})\;\mathbf{then}\;\Varid{n}\;\mathbf{else}\;\Varid{o}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{distProb}\;(\Varid{x},\Varid{y})\mathrel{=}\map \;(\Varid{id}\times(\mathbin{*}\Varid{y}))\;\Varid{x}\mbox{\onelinecomment 6}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{collectProb}\;\Varid{x}\mathrel{=}\Varid{set}\;[\mskip1.5mu \Varid{k}\mapsto[\mskip1.5mu \Varid{d'}\mid (\Varid{k'},\Varid{d'})\leftarrow \Varid{x},\Varid{k'}\equiv \Varid{k}\mskip1.5mu]\mid (\Varid{k},\Varid{d})\leftarrow \Varid{x}\mskip1.5mu]\mbox{\onelinecomment 7}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
\\
...
\column{15}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{drawTruchet}\;\Varid{x}\;\Varid{y}\mathrel{=}\Varid{display}\;\Varid{janela1}\;\Varid{white}\;\Varid{pic}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{pic}\mathrel{=}\Varid{mconcat}\;(\Varid{mapGen}\;\Varid{x}\;\Varid{y}){}\<[E]%
\\
\>[9]{}\hsindent{6}{}\<[15]%
\>[15]{}\Varid{janela1}\mathrel{=}\Conid{InWindow}\;\text{\ttfamily \char34 Truchet\char34}\;(\mathrm{80}\mathbin{*}\Varid{x},\mathrm{80}\mathbin{*}\Varid{y})\;(\mathrm{100},\mathrm{100}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\\
...
\column{81E}{@{}l@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mapGen}\;\Varid{comp}\;\Varid{lar}\mathrel{=}\Varid{truchetSmithGen}\;\Varid{genTruchet}\;\Varid{mapCenter}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{mapCenter}\mathrel{=}\map \;(\map \;({}\<[34]%
\>[34]{}((\mathbin{+}\Varid{leftshift})\comp \Varid{realToFrac})\times{}\<[66]%
\>[66]{}((\mathbin{+}\Varid{downshift})\comp \Varid{realToFrac})))\;\Varid{mapCoords}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{mapCoords}\mathrel{=}[\mskip1.5mu [\mskip1.5mu (\Varid{x}\mathbin{*}\mathrm{80},\Varid{y}\mathbin{*}\mathrm{80}),(\Varid{x}\mathbin{*}\mathrm{80}\mathbin{+}\mathrm{80},\Varid{y}\mathbin{*}\mathrm{80}),(\Varid{x}\mathbin{*}\mathrm{80},\Varid{y}\mathbin{*}\mathrm{80}\mathbin{+}\mathrm{80}),(\Varid{x}\mathbin{*}\mathrm{80}\mathbin{+}\mathrm{80},\Varid{y}\mathbin{*}\mathrm{80}\mathbin{+}\mathrm{80})\mskip1.5mu]\mid {}\<[E]%
\\
\>[9]{}\hsindent{12}{}\<[21]%
\>[21]{}\Varid{x}\leftarrow [\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\Varid{comp}\mathbin{-}\mathrm{1}\mskip1.5mu],\Varid{y}\leftarrow [\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\Varid{lar}\mathbin{-}\mathrm{1}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{leftshift}\mathrel{=}(\mathbin{-}((\Varid{realToFrac}\;\Varid{comp})\mathbin{/}\mathrm{2}\mathbin{*}\mathrm{80})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{downshift}\mathrel{=}(\mathbin{-}((\Varid{realToFrac}\;\Varid{lar})\mathbin{/}\mathrm{2}\mathbin{*}\mathrm{80})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{genTruchet}\mathrel{=}\Varid{unsafePerformIO}\;(\Varid{permuta}\;\Varid{genTruchetList}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{genTruchetList}\mathrel{=}\mathsf{conc}\;({}\<[34]%
\>[34]{}\Varid{replicate}\;\Varid{nTruchet1}\;\mathrm{1},\Varid{replicate}\;\Varid{nTruchet2}\;\mathrm{2}{}\<[81]%
\>[81]{}){}\<[81E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{area}\mathrel{=}\Varid{comp}\mathbin{*}\Varid{lar}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{nTruchet1}\mathrel{=}{}\<[22]%
\>[22]{}\Varid{area}\div \mathrm{2}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{nTruchet2}\mathrel{=}{}\<[22]%
\>[22]{}(\Varid{nTruchet1}\mathbin{+}(\Varid{mod}\;\Varid{area}\;\mathrm{2})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{truchetSmithGen}\;\Varid{lts}\;\Varid{lcoords}\mathrel{=}(\Varid{cataList}\;\Varid{g})\;\Varid{lts}\;\Varid{lts}\;\Varid{lcoords}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g1}\;\anonymous \;\anonymous \;\anonymous \mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\mathrm{1},\Varid{j})\;(\mathrm{1}\mathbin{:}\Varid{o})\;(\Varid{l}\mathbin{:}\Varid{ls})\mathrel{=}\mathsf{conc}\;([\mskip1.5mu \Conid{Pictures}\;[\mskip1.5mu \Varid{put}\;(\Varid{l}\mathbin{!!}\mathrm{2})\;(\Conid{Arc}\;(\mathbin{-}\mathrm{90})\;\mathrm{0}\;\mathrm{40}),{}\<[E]%
\\
\>[9]{}\hsindent{24}{}\<[33]%
\>[33]{}\Varid{put}\;(\Varid{l}\mathbin{!!}\mathrm{1})\;(\Conid{Arc}\;\mathrm{90}\;\mathrm{180}\;\mathrm{40})\mskip1.5mu]\mskip1.5mu],\Varid{j}\;\Varid{o}\;\Varid{ls}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g2}\;(\mathrm{2},\Varid{j})\;(\mathrm{2}\mathbin{:}\Varid{o})\;(\Varid{l}\mathbin{:}\Varid{ls})\mathrel{=}\mathsf{conc}\;([\mskip1.5mu \Conid{Pictures}\;[\mskip1.5mu \Varid{put}\;(\Varid{l}\mathbin{!!}\mathrm{0})\;(\Conid{Arc}\;\mathrm{0}\;\mathrm{90}\;\mathrm{40}),{}\<[E]%
\\
\>[9]{}\hsindent{24}{}\<[33]%
\>[33]{}\Varid{put}\;(\Varid{l}\mathbin{!!}\mathrm{3})\;(\Conid{Arc}\;\mathrm{180}\;(\mathbin{-}\mathrm{90})\;\mathrm{40})\mskip1.5mu]\mskip1.5mu],\Varid{j}\;\Varid{o}\;\Varid{ls}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
